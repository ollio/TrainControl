...
public class BlueToothController {
  ...
  public BlueToothController(Activity activity, ActivityCallback callback) {
...
/*
    nameLookupTimer.schedule(new TimerTask() {
      @Override
      public void run() {
        for (TrainControlDevice trainControlDevice : controlDevices ) {
           if(trainControlDevice != activeDeviceWorker.control && trainControlDevice.trainName == null) {
             readName(trainControlDevice);
           }
        }
      }
    }, 10000);
